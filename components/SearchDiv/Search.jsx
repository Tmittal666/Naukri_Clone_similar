    ...
    <div className='searchDiv grid gp-10 bg-greyIsh rounded-[10px] p-[3rem]'>
      <form action="">
        <div className='firstdiv flex justify-between items-center rounded-[8px] gap-[10px] bg-[white] p-5 shadow-lg shadow-greyIsh'>
          ...
          <input type="text" className='input1 bg-transparent text-blue-500 focus:outline-none w-[100%]' placeholder= 'Search Job Here'   />
          <AiOutlineCloseCircle className='text-[30px]  text-[#a5a6a6] hover:text-textColor icon ' />
          </div>

          <div className='flex gap-2 items-center'>
          <BsHouseDoor className= 'text-[25px] icon'/>
          <input type="text" className='input1 bg-transparent text-blue-500 focus:outline-none w-[100%]' placeholder= 'Search by years'   />
          ...
          <input type="text" className='input1 bg-transparent text-blue-500 focus:outline-none w-[100%]' placeholder= 'Search by Location'   />
          <AiOutlineCloseCircle className='text-[30px]  text-[#a5a6a6] hover:text-textColor icon ' />
          </div>
